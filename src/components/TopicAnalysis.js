  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="bg-green-50 p-4 rounded-lg">
        ...
        <p className="text-lg font-bold text-green-700">{bestTopic.topic}</p>
        <p className="text-sm text-green-600">Média de {bestTopic.average}%</p>
      </div>
      <div className="bg-red-50 p-4 rounded-lg">
        <h4 className="font-semibold text-red-800">Tópico a Melhorar</h4>
        <p className="text-lg font-bold text-red-700">{worstTopic.topic}</p>
        <p className="text-sm text-red-600">Média de {worstTopic.average}%</p>
      </div>
    </div>
  );
};
